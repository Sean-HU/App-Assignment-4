var EmployeeService = function() {
    ...
    this.findByName = function(searchFirst, searchLast) {
        ...
        var results = employees.filter(function(element) {
            ...
            //toLowerCase functions after searchFirst and searchLast were removed 
            //so that results are only displayed if the user enters lowercase letters
            return (first.toLowerCase().indexOf(searchFirst) > -1) && (last.toLowerCase().indexOf(searchLast) > -1);
        });
